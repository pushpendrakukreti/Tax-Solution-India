...
$insertobj = new admin();
$msg=$insertobj->insert_key_date_details("key_date");
}
?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>A S N & COMPANY | Add Key Date </title>
        ...
        <div class='col-md-12'>
          <div class='box box-info'>
            <div class='box-header'>
              <h3 class='box-title'>Add Key Date</h3>
            ...
            <form method="post" enctype="multipart/form-data">
              <div class='box-body pad'>
                <div class="form-group">
                 ...
                 <input type="text" name="Due_Dates" class="form-control" placeholder="Enter Due Dates ...">
                </div>
                ...
                <div class="form-group">
                 ...
                 <input type="text" name="Challan_Number" class="form-control" placeholder="Enter Form / Challan Number ...">
                </div>                
