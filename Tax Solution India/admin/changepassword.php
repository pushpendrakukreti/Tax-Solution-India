...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Footloose | Changepassword</title>
             ...
             <div class='col-md-12'>
              ...
              <div class='box-body pad'>
				...
				<div class="form-group">
                  ...
                  <input type="password" name="conpass" class="form-control" placeholder="Enter Confirm Password">
                </div>
...
$result=mysql_query("SELECT password FROM login Where id=1 ") or die(mysql_error());
...
$result=mysql_query("update login set password='$_POST[conpass]' WHERE id=1 ") or die(mysql_error());
